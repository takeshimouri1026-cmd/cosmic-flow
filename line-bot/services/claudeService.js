 ...
 */
export async function analyzeMessage({ senderName, person, text, existingPrefs, recentMessages = [], behaviorNotes = [] }) {
...
- 「相づち」「実況」「감想の連投」はしない。言いたくなっても、ぐっとこらえるのが今のおへやちゃんの成長点。
